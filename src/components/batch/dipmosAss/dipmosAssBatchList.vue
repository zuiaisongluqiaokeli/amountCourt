    ...
    <div class="batchModel">
        <Row>
            <Form ref="searchForm" :model="searchForm" inline :label-width="80" class="search-form">
                ...
                <Form-item label="案由">
                    <Select v-model="searchForm.briefName" @on-change="selBrief" clearable filterable placeholder="请选择" style="width: 170px">
                ...
                <Form-item label="流水号">
                    <Input type="text" v-model="searchForm.flowNumber" clearable placeholder="请输入流水号" style="width: 190px"/>
                </Form-item>
        ...
        <div  style="margin-bottom:25px">
            <Row class="tables">
                <Col span='15'>
                    <Table size="small" stripe height='420' :loading="loading" border :columns="columns" :data="listData" ref="tables" sortable="custom" @on-row-click="(data,index)=> rowClick(data,index,'tables')" @on-selection-change="changeSelect"></Table>
    ...
    data(){
        return{
            searchForm:{
                ...
                type:"文书生成",  //案件类型，枚举类型 待审核/审核通过待分案
                pageNumber: 1,
                pageSize: 10,
            },
            briefList:[],   //案由列表
