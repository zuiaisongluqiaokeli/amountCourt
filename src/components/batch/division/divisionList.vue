    ...
    <div class="batchModel">
        <Row>
            <Form ref="searchForm" :model="searchForm" inline :label-width="80" class="search-form">
                <Form-item label="网申号" v-show="!isCase">
                    <Input type="text" v-model="searchForm.netApplicationNo" clearable placeholder="网申号" style="width: 190px"/>
                </Form-item>
                <Form-item label="案号" v-show="isCase">
                    <Input type="text" v-model="searchForm.caseNo" clearable placeholder="网申号" style="width: 190px"/>
                </Form-item>
...
export default {
    ...
    methods:{
        init(dex){
            ...
            if(dex == 1){
                 this.isCase = true;
                 this.columns = allColums.caseLeftColums;
            }else{
                if(dex == 9){
                    this.searchForm.division = 1;
                }
                 this.isCase = false;
            }
        ...
        handleSearch(){
            ...
            this.loading = true;
            lawCaseList(this.searchForm).then(res => {
                this.loading = false;
        ...
        shiftIn(){
            ...
            for(let i=0;i<this.selectList.length;i++){
                for(let u=0;u<this.listData.length;u++){
                    if(this.selectList[i].id == this.listData[u].id){
        ...
        ShiftOut(){
            ...
            for(let i=0;i<this.selectList2.length;i++){
                for(let u=0;u<this.selectedData.length;u++){
                    if(this.selectList2[i].id == this.selectedData[u].id){
