...
<template>
    <div ref="scrollCon" @DOMMouseScroll="handlescroll" @mousewheel="handlescroll" class="tags-outer-scroll-con">
        ...
        <div class="btn-con left-btn">
            <Button type="text" @click="tagClicks">
                <Icon :size="18" :type="shrinks" />
            </Button>
        </div>
        <div ref="scrollBody"  class="tags-inner-scroll-body" :style="{left: tagBodyLeft ? 0 : 30 + 'px'}" >
...
export default {
    ...
    methods: {
        ...
        tagClicks(){
            if(this.shrinks == 'ios-arrow-back'){
                this.shrinks = 'ios-arrow-forward'
            }else{
                this.shrinks = 'ios-arrow-back';
            }
        ...
        handlescroll (e) {
            ...
            let left = 30;
            if (delta > 0) {
                left = Math.min(30, this.tagBodyLeft + delta);
            } else {
