  ...
  <div>
      ...
      <Form label-position="right" style="margin:0 auto;width: 441px;margin-top:15px">
        <FormItem>
          <div class='ft_public1'>
            <a href="javascript:void(0)" style="" class="ft_public2 " @click="addcontract('creditContract','credidList')">增加授信合同</a>
          </div>
        </FormItem>
      </Form>
    </div>
    ...
    <div v-if="sw2==true">
      ...
      <Form label-position="right" style="margin:0 auto;width: 441px;margin-top:15px">
        <FormItem>
          <div class='ft_public1'>
            <a href="javascript:void(0)" style="" class="ft_public2 " @click="addcontract('loanContract','loanList')">增加借款合同</a>
          </div>
        </FormItem>
      </Form>
    </div>
    ...
    <div v-if="sw3==true">
      ...
      <Form label-position="right" style="margin:0 auto;width: 441px;margin-top:15px">
        <FormItem>
          <div class='ft_public1'>
            <a href="javascript:void(0)" style="" class="ft_public2 " @click="addcontract('ensureContract','ensureList')">增加保证合同</a>
          </div>
        </FormItem>
      </Form>
    </div>
    ...
    <div v-if="sw4==true">
      ...
      <Form label-position="right" style="margin:0 auto;width: 441px;margin-top:15px">
        <FormItem>
          <div class='ft_public1'>
            <a href="javascript:void(0)" style="" class="ft_public2 " @click="addcontract('mortgageContract','pawnList')">增加抵押合同</a>
          </div>
        </FormItem>
      </Form>
    </div>
    ...
    <div v-if="sw5==true">
      ...
      <Form label-position="right" style="margin:0 auto;width: 441px;margin-top:15px">
        <FormItem>
          <div class='ft_public1'>
            <a href="javascript:void(0)" style="" class="ft_public2 " @click="addcontract('impawnContract','impawnList')">增加抵押合同</a>
          </div>
        </FormItem>
      </Form>
    </div>
