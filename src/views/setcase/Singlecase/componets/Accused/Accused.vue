<template>
  <div class='ft-plant-div1'>
    ...
    <div class='ft_public1' style="width:720px;margin: 0 auto;margin-bottom:30px;">
      <a href="javascript:void(0)" class="ft-accused-btn1" @click="ft_accused_backToStep2">返回上一步</a>
      <a href="javascript:void(0)" class="ft_public3" @click="ft_accused_jumptoStep3">下一步，要素信息</a>
    </div>
  </div>
</template>
...
export default {
  ...
  methods:{
    ...
    ft_accused_backToStep2 () {
      this.$emit('ft_accused_backToStep2',{type:0,data:{accused_confirmList:this.accused_confirmList,third_confirmList:this.third_confirmList}});
    },
    ...
    nextSteps(res1,res2){
      ...
      if(!res1) {
        ...
        this.$emit('ft_accused_backToStep2',{type:1,data:{accused_confirmList:res1,third_confirmList:res2}});
      }
    },
    //删除被告、第三人信息
